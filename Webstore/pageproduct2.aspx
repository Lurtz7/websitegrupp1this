<%@ Page MasterPageFile="~/WebshopMaster.Master" Language="C#" AutoEventWireup="true" CodeBehind="pageProduct2.aspx.cs" Inherits="Webstore.pageProduct" %>
...
<asp:Content ContentPlaceHolderID="main_content" runat="server">
        <div class="mainContent">
            <div class="divImageProduct"><img src="https://static.pexels.com/photos/39554/stapler-office-paper-work-39554.jpeg" alt="häftapparat" style="width:100%;height:auto" /></div>
            <div class="divProductPrice">
                <table id="tableProduct" style="width: 100%;">
                    <tr>
                        <th id="thProductName" colspan="2" class="auto-style8">Häftapparat</th>                        
                    </tr>
                    <tr>
